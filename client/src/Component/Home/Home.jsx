...
function HomeComponent() {
    ...
    const [countriesPerPage, setCountriesPerPage] = useState(9) //paises por pagina que siempre van a ser 9
...
const paginado = (pageNumber) => {
    ...
    function handleClick(e) {
        e.preventDefault(); //es preventivo, para que cuando se recargue la pagina no se rompa nada.
